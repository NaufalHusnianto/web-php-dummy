...
<body class="p-4">
    ...
    <table class="table mt-2">
        ...
        <tr>
            ...
            <td><?= $user['role'] ?></td>
            <td>
                <a href="show-user.php?id=<?= $user['id'] ?>" class="btn btn-info">Detail</a>
                <a href="edit-user.php?id=<?= $user['id'] ?>" class="btn btn-warning">Edit</a>
                <a href="delete-user.php?id=<?= $user['id'] ?>" class="btn btn-danger" onclick="return confirm('Yakin menghapus data?')">Delete</a>
            </td>
        </tr>
        <?php
            $no++;
